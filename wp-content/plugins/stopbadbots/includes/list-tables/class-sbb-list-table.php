<?php class sbb_List_Table extends WP_List_Table
{
    ...
    public function get_columns()
    {
        $columns = array(
            ...
            'botnickname' => _x('Nickname', 'Column label', 'stopbadbots'),
            'botname' => _x('Name', 'Column label', 'stopbadbots'),
        ...
        if ('activate' === $this->current_action()) {
            ...
            if (isset($_GET['bot'])) {
                ...
                foreach ($_GET['bot'] as $botid) {
                    ...
                    $result = $wpdb->update($wpdb->prefix . 'sbb_blacklist', array('botstate' =>
                            'Enabled'), array("id" => $botid));
