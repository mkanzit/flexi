		...
		if( isset($element_content->content) ):
			$html .= '
				<!--[if (gte mso 9)|(IE)]>
					<table class="content-twocol" style="table-layout:fixed; width:100%">
						<tr>
							<td>
				<![endif]-->
					<table class="content-twocol" align="left" width="276" cellspacing="0" cellpadding="0">
						<tr>
							<td style="width:50%">
				...
				<!--[if (gte mso 9)|(IE)]>
							...
							<td>
				<![endif]-->
					<table class="content-twocol" align="right" width="276" cellspacing="0" cellpadding="0">
						<tr>
							<td style="width:50%">
